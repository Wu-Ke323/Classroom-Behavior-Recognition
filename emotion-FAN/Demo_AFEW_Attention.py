...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        prec1 , prec_score , target_vector = validate(val_loader, model)
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    index_matrix = torch.stack(index_matrix, dim=0).cuda().float()  # [21570]  --->  [380, 21570]
...
def validate(val_loader, model):
    ...
    with torch.no_grad():
        ...
        return topVideo.avg , pred_score , target_vector
