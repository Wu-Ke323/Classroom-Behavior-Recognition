...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='data/action')
    parser.add_argument(
        '--out_folder', default='data/Action')
    arg = parser.parse_args()

    part = ['train', 'val']
    for p in part:
        data_path = '{}/action_{}'.format(arg.data_path, p)
        label_path = '{}/action_{}_label.json'.format(arg.data_path, p)
